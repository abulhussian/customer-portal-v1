...
//               <Avatar className="h-5 w-5 ring-2 ring-white/30 mb-5">
...
//           <div className="flex-1 z-2 w-full h-full pl-2 pt-0 pr-0 pb-0  bg-white z-11"style={{ borderTopLeftRadius: "50px" }}>
//           {children}
//           </div>
//           </div>
